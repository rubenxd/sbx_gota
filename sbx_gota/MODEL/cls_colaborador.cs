...
namespace sbx_gota.MODEL
{
    public class cls_colaborador
    {
        ...
        //Metodos
        public DataTable mtd_consultar_colaborador()
        {
            v_query = " EXECUTE sp_consultar_colaboradores  '" + v_buscar + "' ";
            v_dt = cls_datos.mtd_consultar(v_query);
            return v_dt;
        }

        public DataTable mtd_consultar_colaborador_exacto()
        {
            v_query = " SELECT * FROM tbl_colaborador WHERE Id = '" + v_buscar + "' ";
            v_dt = cls_datos.mtd_consultar(v_query);
            return v_dt;
        }
        ...
        {
            v_query = " INSERT INTO tbl_colaborador (TipoIdentificacion,NumeroIdentificacion,Nombres,Apellidos,Celular,Direccion,FechaRegistro)" +
        ...
        {
            v_query = " UPDATE tbl_colaborador SET TipoIdentificacion = @TipoIdentificacion,NumeroIdentificacion = @NumeroIdentificacion,Nombres = @Nombres,  " +
        ...
        {
            v_query = "DELETE FROM tbl_colaborador WHERE Id = '" + Id + "'";
